    ...
    class ExpeditedUpdate {
        ...
        static dispatchCommitExpeditionChoiceV2(updates) {
            ...
            return new WinJS.Promise(function (completeDispatch, errorDispatch /*, progressDispatch*/) {
                ...
                AppObjectFactory.getInstance().getObjectFromString("CloudExperienceHostAPI.OobeExpeditedUpdateManagerStatics").commitExpeditionChoiceAsyncV2(updatesList.getView()).then(() => {
